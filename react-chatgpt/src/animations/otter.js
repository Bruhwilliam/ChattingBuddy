...
function animateIdle() {
	...
	startAnimation("INTRO_IDLE", ["INTRO_IDLE"], img, src, 2, 240, 0, 0, 0);
}
function animateEat() {
	const img = document.getElementById('otter');
	...
	startAnimation("INTRO_EAT", ["INTRO_EAT"], img, src, 32, 10, 0, 0, 0);
}
function animateSleep() {
	...
	startAnimation("INTRO_SLEEP", ["INTRO_SLEEP"], img, src, 12, 30, 0, 0, 0);
}
